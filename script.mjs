(async function () {
  ...
  employeeList.addEventListener("click", (e) => {
    console.log(e.target, selectedEmployeeId);
  ...
  const renderSingleEmployee = () => {
    ...
    console.log("23", selectedEmployee);
    employeeInfo.innerHTML = `
  ...
  const renderEmployees = () => {
    ...
    employees.forEach((element) => {
      ...
      emp.classList.add("employees_names--item");
      ...
      emp.setAttribute("id", emp.id);
      emp.innerHTML = `${element.firstName}  ${element.lastName} 
